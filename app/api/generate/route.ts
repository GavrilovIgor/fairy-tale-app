...
function getBlankProfile(ageStr: string): { count: string; examples: string } {
  ...
  ✓ "Он чувствовал себя ___." → "одиноким", "сильным", "растерянным"
  ✓ "В животе что-то ___." → "сжалось", "потеплело", "перевернулось"`,
  }
  return {
    count: '6–8 пропусков на сцену',
    examples: `Возраст 10+: пропуски — мысль, решение, вывод, эмоциональное состояние.
  ✓ "Он понял, что настоящая смелость — это ___."
  ✓ "Самое важное, что он узнал: ___."
  ✓ "Герой решил, что теперь будет ___."
  ✓ "Внутри что-то изменилось — он стал ___."`,
  }
}

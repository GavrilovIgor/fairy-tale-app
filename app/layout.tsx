    ...
    <html lang={locale} className={`${jakarta.variable} h-full antialiased`}>
      ...
      <body className="min-h-full flex flex-col">
        ...
        <Script id="yandex-metrika" strategy="afterInteractive">{`
          ...
          ym(109382340,"init",{clickmap:true,trackLinks:true,accurateTrackBounce:true,webvisor:true});
        `}</Script>
        <noscript><div><img src="https://mc.yandex.ru/watch/109382340" style={{position:"absolute",left:"-9999px"}} alt="" /></div></noscript>
      </body>
    </html>
  )
}
